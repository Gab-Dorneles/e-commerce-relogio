...
public record UsuarioResponseDTO(
    ...
    public UsuarioResponseDTO (Usuario usuario, String perfil) {
        this(usuario.getId(), usuario.getNome(), usuario.getCpf(), usuario.getEmail(), usuario.getLogin(), perfil != null? perfil : usuario.getPerfil().getLabel(), usuario.getTelefones().stream().map(telefone -> telefone.getNumero()).toList());
    }
